...
modify the contents of the `src/fragment_py/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/fragment-dev/fragment-py.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/fragment-dev/fragment-py/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
